...
const Card = ({ index, cardData }) => {
  return (
    <div className="relative flex flex-col items-center justify-center w-full rounded-xl py-2 my-4 bg-white border-transparent border-1 hover:shadow-sm hover:border-slate-500/2">
